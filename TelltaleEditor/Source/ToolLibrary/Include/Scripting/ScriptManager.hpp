...
inline void Execute(LuaManager &man, U32 Nargs, U32 Nresults) { man.CallFunction(Nargs, Nresults); }
...
inline void RunText(LuaManager &man, const String &code) { man.RunText(code.c_str(), (U32)code.length()); }
