...
public:
    ...
    ResourceScheme GetScheme() const {
        return _Scheme;
    }
    
    // Returns the path of the URL, without the scheme prefix.
    inline String GetRawPath() const {
        return _Path;
    }
    ...
    inline operator bool() const {
        return _Scheme != ResourceScheme::INVALID;
    }
...
public:
    ...
    inline virtual const ResourceURL& GetURL() {
...
public:
    ...
    inline static DataStreamManager* GetInstance() {
        return Instance;
    }
