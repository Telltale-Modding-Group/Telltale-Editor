...
Bool LuaAdapter_502::LoadChunk(const String &nm, const U8 *buf, U32 sz, Bool)
{
...
Bool LuaAdapter_502::CheckStack(U32 extra) { return lua_checkstack(_State, (int)extra); }
...
I32 LuaAdapter_502::UpvalueIndex(I32 index) { return lua_upvalueindex(index); }

void LuaAdapter_502::Pop(U32 N) { lua_pop(_State, (int)N); }

I32 LuaAdapter_502::GetTop() { return (I32)lua_gettop(_State); }
...
void LuaAdapter_502::SetTableRaw(I32 index, I32 arrayIndex) { lua_rawseti(_State, (int)index, (int)arrayIndex); }

void LuaAdapter_502::GetTableRaw(I32 index, I32 arrayIndex) { lua_rawgeti(_State, (int)index, (int)arrayIndex); }

I32 LuaAdapter_502::TableNext(I32 index) { return (int)lua_next(_State, (int)index); }
...
CString LuaAdapter_502::Typename(LuaType t) { return lua_typename(_State, (int)t); }

Bool LuaAdapter_502::GetMetatable(I32 index) { return (Bool)lua_getmetatable(_State, index); }

Bool LuaAdapter_502::SetMetatable(I32 index) { return (Bool)lua_setmetatable(_State, index); }

void LuaAdapter_502::SetTop(I32 index) { lua_settop(_State, (int)index); }

void LuaAdapter_502::PushCopy(I32 index) { lua_pushvalue(_State, (int)index); }

void LuaAdapter_502::Remove(I32 index) { lua_remove(_State, (int)index); }

void LuaAdapter_502::Insert(I32 index) { lua_insert(_State, (int)index); }

void LuaAdapter_502::Replace(I32 index) { lua_replace(_State, (int)index); }

Bool LuaAdapter_502::ToBool(I32 index) { return (Bool)lua_toboolean(_State, (int)index); }

Float LuaAdapter_502::ToFloat(I32 index) { return (Float)lua_tonumber(_State, (int)index); }

String LuaAdapter_502::ToString(I32 index) { return String(lua_tostring(_State, (int)index)); }

void *LuaAdapter_502::ToPointer(I32 index) { return const_cast<void *>(lua_topointer(_State, (int)index)); }

void LuaAdapter_502::Error() { lua_error(_State); }

I32 LuaAdapter_502::ToInteger(I32 index) { return (I32)lua_tonumber(_State, (int)index); }
