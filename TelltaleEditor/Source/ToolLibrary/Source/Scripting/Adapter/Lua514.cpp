...
I32 LuaAdapter_514::UpvalueIndex(I32 index) { return lua_upvalueindex(index); }
...
Bool LuaAdapter_514::CheckStack(U32 extra) { return lua_checkstack(_State, (int)extra); }
...
void LuaAdapter_514::Pop(U32 N) { lua_pop(_State, (int)N); }

I32 LuaAdapter_514::GetTop() { return (I32)lua_gettop(_State); }
...
void LuaAdapter_514::SetTableRaw(I32 index, I32 arrayIndex) { lua_rawseti(_State, (int)index, (int)arrayIndex); }

void LuaAdapter_514::GetTableRaw(I32 index, I32 arrayIndex) { lua_rawgeti(_State, (int)index, (int)arrayIndex); }

I32 LuaAdapter_514::TableNext(I32 index) { return (int)lua_next(_State, (int)index); }
...
CString LuaAdapter_514::Typename(LuaType t) { return lua_typename(_State, (int)t); }

Bool LuaAdapter_514::GetMetatable(I32 index) { return (Bool)lua_getmetatable(_State, index); }

Bool LuaAdapter_514::SetMetatable(I32 index) { return (Bool)lua_setmetatable(_State, index); }

void LuaAdapter_514::SetTop(I32 index) { lua_settop(_State, (int)index); }

void LuaAdapter_514::PushCopy(I32 index) { lua_pushvalue(_State, (int)index); }

void LuaAdapter_514::Remove(I32 index) { lua_remove(_State, (int)index); }

void LuaAdapter_514::Insert(I32 index) { lua_insert(_State, (int)index); }

void LuaAdapter_514::Replace(I32 index) { lua_replace(_State, (int)index); }

Bool LuaAdapter_514::ToBool(I32 index) { return (Bool)lua_toboolean(_State, (int)index); }

Float LuaAdapter_514::ToFloat(I32 index) { return (Float)lua_tonumber(_State, (int)index); }

String LuaAdapter_514::ToString(I32 index) { return String(lua_tolstring(_State, (int)index, 0)); }

void *LuaAdapter_514::ToPointer(I32 index) { return const_cast<void *>(lua_topointer(_State, (int)index)); }

void LuaAdapter_514::Error() { lua_error(_State); }

I32 LuaAdapter_514::ToInteger(I32 index) { return (I32)lua_tointeger(_State, (int)index); }
