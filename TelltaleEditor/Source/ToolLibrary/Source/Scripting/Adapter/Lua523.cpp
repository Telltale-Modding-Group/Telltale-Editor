...
I32 LuaAdapter_523::UpvalueIndex(I32 index) { return lua_upvalueindex(index); }
...
Bool LuaAdapter_523::CheckStack(U32 extra) { return lua_checkstack(_State, (int)extra); }
...
void LuaAdapter_523::Pop(U32 N) { lua_pop(_State, (int)N); }

I32 LuaAdapter_523::GetTop() { return (I32)lua_gettop(_State); }
...
void LuaAdapter_523::SetTableRaw(I32 index, I32 arrayIndex) { lua_rawseti(_State, (int)index, (int)arrayIndex); }

void LuaAdapter_523::GetTableRaw(I32 index, I32 arrayIndex) { lua_rawgeti(_State, (int)index, (int)arrayIndex); }

I32 LuaAdapter_523::TableNext(I32 index) { return (int)lua_next(_State, (int)index); }
...
Bool LuaAdapter_523::Compare(I32 lhs, I32 rhs, LuaOp op) { return (Bool)lua_compare(_State, (int)lhs, (int)rhs, (int)op); }

CString LuaAdapter_523::Typename(LuaType t) { return lua_typename(_State, (int)t); }

Bool LuaAdapter_523::GetMetatable(I32 index) { return (Bool)lua_getmetatable(_State, index); }

Bool LuaAdapter_523::SetMetatable(I32 index) { return (Bool)lua_setmetatable(_State, index); }

void LuaAdapter_523::SetTop(I32 index) { lua_settop(_State, (int)index); }

void LuaAdapter_523::PushCopy(I32 index) { lua_pushvalue(_State, (int)index); }

void LuaAdapter_523::Remove(I32 index) { lua_remove(_State, (int)index); }

void LuaAdapter_523::Insert(I32 index) { lua_insert(_State, (int)index); }

void LuaAdapter_523::Replace(I32 index) { lua_replace(_State, (int)index); }

Bool LuaAdapter_523::ToBool(I32 index) { return (Bool)lua_toboolean(_State, (int)index); }

Float LuaAdapter_523::ToFloat(I32 index) { return (Float)lua_tonumber(_State, (int)index); }

I32 LuaAdapter_523::ToInteger(I32 index) { return (I32)lua_tointeger(_State, (int)index); }

String LuaAdapter_523::ToString(I32 index) { return String(lua_tolstring(_State, (int)index, 0)); }

void *LuaAdapter_523::ToPointer(I32 index) { return const_cast<void *>(lua_topointer(_State, (int)index)); }

void LuaAdapter_523::Error() { lua_error(_State); }
