...
void Blowfish::Cipher::_Do(Bool enc, Bool mod, U32& left, U32& right)
{
    ...
    {
        // PERFORM DECRYPTION OF LEFT AND RIGHT BLOCK
...
U32 Blowfish::Cipher::_DoRounds(U32 x)
{
    
    // EXTRACT EACH BYTE FROM X
    U32 d = x & 0x00FF;
    x >>= 8;
    U32 c = x & 0x00FF;
    x >>= 8;
    ...
    // SEE ALGORITHM. ADD THEN XOR, THEN ADD.
    U32 y = S[0][a] + S[1][b];
    y = y ^ S[2][c];
    y = y + S[3][d];
